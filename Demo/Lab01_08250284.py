...
student_list.append("Sonam")#adding student name  to the list
student_list.append("Kelzang")#adding student name to the list
student_list.append("Pema")#adding student name to the list
student_list.append("Dechen")#adding student name  to the list
student_age.add(24)#adaing student age to the set
student_age.add(28)#adaing student age to the set
student_age.add(25)#adaing student age to the set
student_age.add(27)#adaing student age to the set
student_grade.add('A')#adaing student grade to the set
student_grade.add('D')#adaing student  grade to the set
student_grade.add('C')#adaing student grade to the set
student_grade.add('B')#adaing student grade to the set
student_dict['Sonam'] = {'age': 24, 'grade': 'A'}#adding student details to the dictionary
student_dict['Kelzang'] = {'age': 28, 'grade': 'D'}#adding student details to the dictionary
student_dict['Pema'] = {'age': 25, 'grade': 'C'}#adding student details to the dictionary
student_dict['Dechen']= {'age': 27, 'grade': 'B'}#adding student details to the dictionary
...
add_grade = input("Enter the grade of the student: ") #taking input for student grade to be added to the existing set of student grade and also to be added to the dictionary along with the student name
if add_student:#checking if the input for the student 
    ...
    student_dict[add_student] = {'age': add_age, 'grade': add_grade} #adding student details to dictionary
